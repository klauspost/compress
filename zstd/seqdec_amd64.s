...
sequenceDecs_decode_amd64_fill_end:
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_0_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_0_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_1_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_1_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, 16(R10)
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_2_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_2_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_3_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_3_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, 8(R10)
...
sequenceDecs_decode_amd64_fill_2_end:
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_4_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_4_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_5_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_5_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, (R10)
	...
	MOVBQZX DI, R14
	CMPQ    R14, $0x09
	JBE     assert_check_6_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_6_ok_srcline_621:
	SHRQ    $0x10, DI
	MOVWQZX DI, DI
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_7_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_7_ok_srcline_640:
	ADDQ R15, DI
	...
	MOVQ (CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_8_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_8_ok_srcline_658:
	MOVQ (CX)(DI*8), DI

	// Update Match Length State
	MOVBQZX R8, R14
	CMPQ    R14, $0x09
	JBE     assert_check_9_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_9_ok_srcline_621:
	SHRQ    $0x10, R8
	MOVWQZX R8, R8
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_10_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_10_ok_srcline_640:
	ADDQ R15, R8
	...
	MOVQ 24(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_11_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_11_ok_srcline_658:
	MOVQ (CX)(R8*8), R8

	// Update Offset State
	MOVBQZX R9, R14
	CMPQ    R14, $0x09
	JBE     assert_check_12_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_12_ok_srcline_621:
	SHRQ    $0x10, R9
	MOVWQZX R9, R9
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_13_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_13_ok_srcline_640:
	ADDQ R15, R9
	...
	MOVQ 48(CX), CX
	CMPQ R9, $0x00000200
	JB   assert_check_14_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_14_ok_srcline_658:
	MOVQ (CX)(R9*8), R9
...
sequenceDecs_decode_56_amd64_fill_end:
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_15_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_15_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_16_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_16_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, 16(R10)
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_17_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_17_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_18_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_18_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, 8(R10)
	...
	CMOVQEQ CX, R15
	CMPQ    AX, $0x10000000
	JB      assert_check_19_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_19_ok_srcline_602:
	CMPQ R15, $0x10000000
	JB   assert_check_20_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_20_ok_srcline_607:
	ADDQ R15, AX
	MOVQ AX, (R10)
	...
	MOVBQZX DI, R14
	CMPQ    R14, $0x09
	JBE     assert_check_21_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_21_ok_srcline_621:
	SHRQ    $0x10, DI
	MOVWQZX DI, DI
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_22_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_22_ok_srcline_640:
	ADDQ R15, DI
	...
	MOVQ (CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_23_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_23_ok_srcline_658:
	MOVQ (CX)(DI*8), DI

	// Update Match Length State
	MOVBQZX R8, R14
	CMPQ    R14, $0x09
	JBE     assert_check_24_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_24_ok_srcline_621:
	SHRQ    $0x10, R8
	MOVWQZX R8, R8
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_25_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_25_ok_srcline_640:
	ADDQ R15, R8
	...
	MOVQ 24(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_26_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_26_ok_srcline_658:
	MOVQ (CX)(R8*8), R8

	// Update Offset State
	MOVBQZX R9, R14
	CMPQ    R14, $0x09
	JBE     assert_check_27_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_27_ok_srcline_621:
	SHRQ    $0x10, R9
	MOVWQZX R9, R9
	LEAQ    (BX)(R14*1), CX
	MOVQ    DX, R15
	...
	ANDQ    BP, R15
	CMPQ    R15, $0x00000200
	JB      assert_check_28_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_28_ok_srcline_640:
	ADDQ R15, R9
	...
	MOVQ 48(CX), CX
	CMPQ R9, $0x00000200
	JB   assert_check_29_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_29_ok_srcline_658:
	MOVQ (CX)(R9*8), R9
...
sequenceDecs_decode_bmi2_fill_2_end:
	...
	MOVQ 48(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_30_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_30_ok_srcline_691:
	MOVQ (CX)(R8*8), R8
	...
	MOVQ 24(CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_31_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_31_ok_srcline_691:
	MOVQ (CX)(DI*8), DI
	...
	MOVQ (CX), CX
	CMPQ SI, $0x00000200
	JB   assert_check_32_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_32_ok_srcline_691:
	MOVQ (CX)(SI*8), SI
...
sequenceDecs_decode_56_bmi2_fill_end:
	...
	MOVQ 48(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_33_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_33_ok_srcline_691:
	MOVQ (CX)(R8*8), R8
	...
	MOVQ 24(CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_34_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_34_ok_srcline_691:
	MOVQ (CX)(DI*8), DI
	...
	MOVQ (CX), CX
	CMPQ SI, $0x00000200
	JB   assert_check_35_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_35_ok_srcline_691:
	MOVQ (CX)(SI*8), SI
...
check_offset:
	...
	JLS   copy_match
	TESTQ R10, R10
	JNZ   assert_check_36_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_36_ok_srcline_1166:
	MOVQ R9, R14
	SUBQ R11, R14
	CMPQ R13, R11
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_37_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_37_ok_srcline_1301:
	MOVQ R13, R11
	SUBQ $0x10, R11
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ R11, $0x01
	JAE  assert_check_38_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_38_ok_srcline_1301:
	MOVQ R11, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
main_loop:
	...
	JZ    check_offset
	CMPQ  R11, $0x01
	JAE   assert_check_39_ok_srcline_1301
	INT   $0x03
	INT   $0x03

assert_check_39_ok_srcline_1301:
	MOVQ R11, R14
	SUBQ $0x10, R14
	JB   copy_1_small
...
check_offset:
	...
	JLS   copy_match
	TESTQ R10, R10
	JNZ   assert_check_40_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_40_ok_srcline_1166:
	MOVQ R9, R14
	SUBQ R11, R14
	CMPQ R13, R11
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_41_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_41_ok_srcline_1301:
	MOVQ R13, R11
	SUBQ $0x10, R11
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ R11, $0x01
	JAE  assert_check_42_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_42_ok_srcline_1301:
	MOVQ R11, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
copy_match:
	...
	ADDQ R13, DI
	CMPQ R13, $0x01
	JAE  assert_check_43_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_43_ok_srcline_1301:
	MOVQ R13, R12
	SUBQ $0x10, R12
	JB   copy_2_small
...
sequenceDecs_decodeSync_amd64_fill_end:
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_44_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_44_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_45_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_45_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 8(SP)
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_46_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_46_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_47_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_47_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 16(SP)
...
sequenceDecs_decodeSync_amd64_fill_2_end:
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_48_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_48_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_49_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_49_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 24(SP)
	...
	MOVBQZX DI, R13
	CMPQ    R13, $0x09
	JBE     assert_check_50_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_50_ok_srcline_621:
	SHRQ    $0x10, DI
	MOVWQZX DI, DI
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_51_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_51_ok_srcline_640:
	ADDQ R14, DI
	...
	MOVQ (CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_52_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_52_ok_srcline_658:
	MOVQ (CX)(DI*8), DI

	// Update Match Length State
	MOVBQZX R8, R13
	CMPQ    R13, $0x09
	JBE     assert_check_53_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_53_ok_srcline_621:
	SHRQ    $0x10, R8
	MOVWQZX R8, R8
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_54_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_54_ok_srcline_640:
	ADDQ R14, R8
	...
	MOVQ 24(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_55_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_55_ok_srcline_658:
	MOVQ (CX)(R8*8), R8

	// Update Offset State
	MOVBQZX R9, R13
	CMPQ    R13, $0x09
	JBE     assert_check_56_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_56_ok_srcline_621:
	SHRQ    $0x10, R9
	MOVWQZX R9, R9
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_57_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_57_ok_srcline_640:
	ADDQ R14, R9
	...
	MOVQ 48(CX), CX
	CMPQ R9, $0x00000200
	JB   assert_check_58_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_58_ok_srcline_658:
	MOVQ (CX)(R9*8), R9
...
sequenceDecs_decodeSync_amd64_adjust_offset_nonzero:
	...
	CMOVQEQ R15, R14
	CMPQ    AX, $0x00000000
	JAE     assert_check_59_ok_srcline_912
	INT     $0x03
	INT     $0x03

assert_check_59_ok_srcline_912:
	CMPQ AX, $0x00000003
	JB   assert_check_60_ok_srcline_916
	INT  $0x03
	INT  $0x03

assert_check_60_ok_srcline_916:
...
check_offset:
	...
	MOVQ  40(SP), R14
	TESTQ R14, R14
	JNZ   assert_check_61_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_61_ok_srcline_1166:
	MOVQ 48(SP), R14
	SUBQ AX, R14
	CMPQ R13, AX
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_62_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_62_ok_srcline_1301:
	MOVQ R13, AX
	SUBQ $0x10, AX
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ AX, $0x01
	JAE  assert_check_63_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_63_ok_srcline_1301:
	MOVQ AX, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
sequenceDecs_decodeSync_bmi2_fill_2_end:
	...
	MOVQ 48(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_64_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_64_ok_srcline_691:
	MOVQ (CX)(R8*8), R8
	...
	MOVQ 24(CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_65_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_65_ok_srcline_691:
	MOVQ (CX)(DI*8), DI
	...
	MOVQ (CX), CX
	CMPQ SI, $0x00000200
	JB   assert_check_66_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_66_ok_srcline_691:
	MOVQ (CX)(SI*8), SI
...
sequenceDecs_decodeSync_bmi2_adjust_offset_nonzero:
	...
	CMOVQEQ R15, R14
	CMPQ    R12, $0x00000000
	JAE     assert_check_67_ok_srcline_912
	INT     $0x03
	INT     $0x03

assert_check_67_ok_srcline_912:
	CMPQ R12, $0x00000003
	JB   assert_check_68_ok_srcline_916
	INT  $0x03
	INT  $0x03

assert_check_68_ok_srcline_916:
...
check_offset:
	...
	MOVQ  40(SP), R14
	TESTQ R14, R14
	JNZ   assert_check_69_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_69_ok_srcline_1166:
	MOVQ 48(SP), R14
	SUBQ CX, R14
	CMPQ R13, CX
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_70_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_70_ok_srcline_1301:
	MOVQ R13, CX
	SUBQ $0x10, CX
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ CX, $0x01
	JAE  assert_check_71_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_71_ok_srcline_1301:
	MOVQ CX, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
sequenceDecs_decodeSync_safe_amd64_fill_end:
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_72_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_72_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_73_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_73_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 8(SP)
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_74_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_74_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_75_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_75_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 16(SP)
...
sequenceDecs_decodeSync_safe_amd64_fill_2_end:
	...
	CMOVQEQ CX, R14
	CMPQ    AX, $0x10000000
	JB      assert_check_76_ok_srcline_602
	INT     $0x03
	INT     $0x03

assert_check_76_ok_srcline_602:
	CMPQ R14, $0x10000000
	JB   assert_check_77_ok_srcline_607
	INT  $0x03
	INT  $0x03

assert_check_77_ok_srcline_607:
	ADDQ R14, AX
	MOVQ AX, 24(SP)
	...
	MOVBQZX DI, R13
	CMPQ    R13, $0x09
	JBE     assert_check_78_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_78_ok_srcline_621:
	SHRQ    $0x10, DI
	MOVWQZX DI, DI
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_79_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_79_ok_srcline_640:
	ADDQ R14, DI
	...
	MOVQ (CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_80_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_80_ok_srcline_658:
	MOVQ (CX)(DI*8), DI

	// Update Match Length State
	MOVBQZX R8, R13
	CMPQ    R13, $0x09
	JBE     assert_check_81_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_81_ok_srcline_621:
	SHRQ    $0x10, R8
	MOVWQZX R8, R8
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_82_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_82_ok_srcline_640:
	ADDQ R14, R8
	...
	MOVQ 24(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_83_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_83_ok_srcline_658:
	MOVQ (CX)(R8*8), R8

	// Update Offset State
	MOVBQZX R9, R13
	CMPQ    R13, $0x09
	JBE     assert_check_84_ok_srcline_621
	INT     $0x03
	INT     $0x03

assert_check_84_ok_srcline_621:
	SHRQ    $0x10, R9
	MOVWQZX R9, R9
	LEAQ    (BX)(R13*1), CX
	MOVQ    DX, R14
	...
	ANDQ    R15, R14
	CMPQ    R14, $0x00000200
	JB      assert_check_85_ok_srcline_640
	INT     $0x03
	INT     $0x03

assert_check_85_ok_srcline_640:
	ADDQ R14, R9
	...
	MOVQ 48(CX), CX
	CMPQ R9, $0x00000200
	JB   assert_check_86_ok_srcline_658
	INT  $0x03
	INT  $0x03

assert_check_86_ok_srcline_658:
	MOVQ (CX)(R9*8), R9
...
sequenceDecs_decodeSync_safe_amd64_adjust_offset_nonzero:
	...
	CMOVQEQ R15, R14
	CMPQ    AX, $0x00000000
	JAE     assert_check_87_ok_srcline_912
	INT     $0x03
	INT     $0x03

assert_check_87_ok_srcline_912:
	CMPQ AX, $0x00000003
	JB   assert_check_88_ok_srcline_916
	INT  $0x03
	INT  $0x03

assert_check_88_ok_srcline_916:
	ADDQ 144(CX)(AX*8), R14
...
sequenceDecs_decodeSync_safe_amd64_match_len_ofs_ok:
	...
	JZ    check_offset
	CMPQ  AX, $0x01
	JAE   assert_check_89_ok_srcline_1301
	INT   $0x03
	INT   $0x03

assert_check_89_ok_srcline_1301:
	MOVQ AX, R14
	SUBQ $0x10, R14
	JB   copy_1_small
...
check_offset:
	...
	MOVQ  40(SP), R14
	TESTQ R14, R14
	JNZ   assert_check_90_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_90_ok_srcline_1166:
	MOVQ 48(SP), R14
	SUBQ AX, R14
	CMPQ R13, AX
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_91_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_91_ok_srcline_1301:
	MOVQ R13, AX
	SUBQ $0x10, AX
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ AX, $0x01
	JAE  assert_check_92_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_92_ok_srcline_1301:
	MOVQ AX, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
copy_match:
	...
	ADDQ R13, R12
	CMPQ R13, $0x01
	JAE  assert_check_93_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_93_ok_srcline_1301:
	MOVQ R13, CX
	SUBQ $0x10, CX
	JB   copy_2_small
...
sequenceDecs_decodeSync_safe_bmi2_fill_2_end:
	...
	MOVQ 48(CX), CX
	CMPQ R8, $0x00000200
	JB   assert_check_94_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_94_ok_srcline_691:
	MOVQ (CX)(R8*8), R8
	...
	MOVQ 24(CX), CX
	CMPQ DI, $0x00000200
	JB   assert_check_95_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_95_ok_srcline_691:
	MOVQ (CX)(DI*8), DI
	...
	MOVQ (CX), CX
	CMPQ SI, $0x00000200
	JB   assert_check_96_ok_srcline_691
	INT  $0x03
	INT  $0x03

assert_check_96_ok_srcline_691:
	MOVQ (CX)(SI*8), SI
...
sequenceDecs_decodeSync_safe_bmi2_adjust_offset_nonzero:
	...
	CMOVQEQ R15, R14
	CMPQ    R12, $0x00000000
	JAE     assert_check_97_ok_srcline_912
	INT     $0x03
	INT     $0x03

assert_check_97_ok_srcline_912:
	CMPQ R12, $0x00000003
	JB   assert_check_98_ok_srcline_916
	INT  $0x03
	INT  $0x03

assert_check_98_ok_srcline_916:
	ADDQ 144(CX)(R12*8), R14
...
sequenceDecs_decodeSync_safe_bmi2_match_len_ofs_ok:
	...
	JZ    check_offset
	CMPQ  CX, $0x01
	JAE   assert_check_99_ok_srcline_1301
	INT   $0x03
	INT   $0x03

assert_check_99_ok_srcline_1301:
	MOVQ CX, R14
	SUBQ $0x10, R14
	JB   copy_1_small
...
check_offset:
	...
	MOVQ  40(SP), R14
	TESTQ R14, R14
	JNZ   assert_check_100_ok_srcline_1166
	INT   $0x03
	INT   $0x03

assert_check_100_ok_srcline_1166:
	MOVQ 48(SP), R14
	SUBQ CX, R14
	CMPQ R13, CX
	JG   copy_all_from_history
	CMPQ R13, $0x03
	JAE  assert_check_101_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_101_ok_srcline_1301:
	MOVQ R13, CX
	SUBQ $0x10, CX
	JB   copy_4_small
...
copy_all_from_history:
	CMPQ CX, $0x01
	JAE  assert_check_102_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_102_ok_srcline_1301:
	MOVQ CX, R15
	SUBQ $0x10, R15
	JB   copy_5_small
...
copy_match:
	...
	ADDQ R13, R11
	CMPQ R13, $0x01
	JAE  assert_check_103_ok_srcline_1301
	INT  $0x03
	INT  $0x03

assert_check_103_ok_srcline_1301:
	MOVQ R13, R12
	SUBQ $0x10, R12
	JB   copy_2_small
