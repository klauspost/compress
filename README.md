...
* [lzw](https://github.com/klauspost/compress/tree/master/lzw) is a drop-in replacement for `compress/lzw` with 3-4x faster decompression and 1.4-2.7x faster compression.
