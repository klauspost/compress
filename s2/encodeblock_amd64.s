...
repeat_extend_back_loop_encodeBetterBlockAsm:
	CMPL SI, DI
	JLE  repeat_extend_back_end_encodeBetterBlockAsm
	MOVB -1(DX)(BP*1), BL
	MOVB -1(DX)(SI*1), R8
	CMPB BL, R8
...
repeat_extend_back_end_encodeBetterBlockAsm:
	...
	CMPL BP, $0x00000100
	JLT  two_bytes_repeat_emit_encodeBetterBlockAsm
	CMPL BP, $0x00010000
	JLT  three_bytes_repeat_emit_encodeBetterBlockAsm
	CMPL BP, $0x01000000
...
four_bytes_repeat_emit_encodeBetterBlockAsm:
	MOVL BP, R10
	SHRL $0x10, R10
	MOVB $0xf8, (AX)
	MOVW BP, 1(AX)
...
two_bytes_repeat_emit_encodeBetterBlockAsm:
	...
	ADDQ $0x02, AX
	CMPL BP, $0x40
	JL   memmove_repeat_emit_encodeBetterBlockAsm
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm
...
memmove_repeat_emit_encodeBetterBlockAsm:
	LEAQ (AX)(R8*1), BP

	// genMemMoveShort
	CMPQ R8, $0x03
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm_memmove_move_1or2
	JE   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm_memmove_move_3
	CMPQ R8, $0x08
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm_memmove_move_4through7
	CMPQ R8, $0x10
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm_memmove_move_3:
	MOVW (R9), R10
	MOVB 2(R9), R9
	MOVW R10, (AX)
	MOVB R9, 2(AX)
...
emit_literal_done_repeat_emit_encodeBetterBlockAsm:
	...
	XORL R11, R11
	CMPL R8, $0x08
	JL   matchlen_single_repeat_extend_encodeBetterBlockAsm

matchlen_loopback_repeat_extend_encodeBetterBlockAsm:
	MOVQ  (R9)(R11*1), R10
	XORQ  (BP)(R11*1), R10
	TESTQ R10, R10
	JZ    matchlen_loop_repeat_extend_encodeBetterBlockAsm
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R11)(R10*1), R11
...
matchlen_loop_repeat_extend_encodeBetterBlockAsm:
	...
	LEAL 8(R11), R11
	CMPL R8, $0x08
	JGE  matchlen_loopback_repeat_extend_encodeBetterBlockAsm
...
matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm:
	...
	LEAL 1(R11), R11
	DECL R8
	JNZ  matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm
...
repeat_extend_forward_end_encodeBetterBlockAsm:
	...
	MOVL  16(SP), SI
	TESTL DI, DI
	JZ    repeat_as_copy_encodeBetterBlockAsm

	// emitRepeat
emit_repeat_again_match_repeat_encodeBetterBlockAsm:
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_match_repeat_encodeBetterBlockAsm
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_match_repeat_encodeBetterBlockAsm

cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm:
	CMPL BP, $0x00000104
	JLT  repeat_three_match_repeat_encodeBetterBlockAsm
	CMPL BP, $0x00010100
	JLT  repeat_four_match_repeat_encodeBetterBlockAsm
	CMPL BP, $0x0100ffff
	JLT  repeat_five_match_repeat_encodeBetterBlockAsm
	LEAL -16842747(BP), BP
	MOVW $0x001d, (AX)
	MOVW $0xfffb, 2(AX)
	MOVB $0xff, 4(AX)
	ADDQ $0x05, AX
	JMP  emit_repeat_again_match_repeat_encodeBetterBlockAsm
...
repeat_four_match_repeat_encodeBetterBlockAsm:
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_as_copy_encodeBetterBlockAsm:
	// emitCopy
	CMPL SI, $0x00010000
	JL   two_byte_offset_repeat_as_copy_encodeBetterBlockAsm

four_bytes_loop_back_repeat_as_copy_encodeBetterBlockAsm:
	CMPL BP, $0x40
	JLE  four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm
	MOVB $0xff, (AX)
	MOVL SI, 1(AX)
	LEAL -64(BP), BP
	ADDQ $0x05, AX
	CMPL BP, $0x04
	JL   four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm

	// emitRepeat
emit_repeat_again_repeat_as_copy_encodeBetterBlockAsm_emit_copy:
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm_emit_copy
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm_emit_copy
	CMPL BP, $0x00010100
	JLT  repeat_four_repeat_as_copy_encodeBetterBlockAsm_emit_copy
	CMPL BP, $0x0100ffff
	JLT  repeat_five_repeat_as_copy_encodeBetterBlockAsm_emit_copy
	LEAL -16842747(BP), BP
	MOVW $0x001d, (AX)
	MOVW $0xfffb, 2(AX)
	MOVB $0xff, 4(AX)
	ADDQ $0x05, AX
	JMP  emit_repeat_again_repeat_as_copy_encodeBetterBlockAsm_emit_copy

repeat_five_repeat_as_copy_encodeBetterBlockAsm_emit_copy:
	LEAL -65536(BP), BP
	MOVL BP, SI
	MOVW $0x001d, (AX)
	MOVW BP, 2(AX)
...
four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm:
	TESTL BP, BP
	JZ    repeat_end_emit_encodeBetterBlockAsm
	MOVB  $0x03, BL
	LEAL  -4(BX)(BP*4), BP
	MOVB  BP, (AX)
	MOVL  SI, 1(AX)
...
two_byte_offset_repeat_as_copy_encodeBetterBlockAsm:
	CMPL BP, $0x40
	JLE  two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm
	MOVB $0xee, (AX)
	MOVW SI, 1(AX)
	LEAL -60(BP), BP
	ADDQ $0x03, AX
	...
	// emitRepeat
emit_repeat_again_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short:
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short
	CMPL BP, $0x00010100
	JLT  repeat_four_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short
	CMPL BP, $0x0100ffff
	JLT  repeat_five_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short
	LEAL -16842747(BP), BP
	MOVW $0x001d, (AX)
	MOVW $0xfffb, 2(AX)
	MOVB $0xff, 4(AX)
	ADDQ $0x05, AX
	JMP  emit_repeat_again_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short

repeat_five_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short:
	LEAL -65536(BP), BP
	MOVL BP, SI
	MOVW $0x001d, (AX)
	MOVW BP, 2(AX)
...
repeat_three_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short:
	LEAL -4(BP), BP
	MOVW $0x0015, (AX)
	MOVB BP, 2(AX)
	ADDQ $0x03, AX
...
repeat_two_repeat_as_copy_encodeBetterBlockAsm_emit_copy_short:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
emit_copy_three_repeat_as_copy_encodeBetterBlockAsm:
	MOVB $0x02, BL
	LEAL -4(BX)(BP*4), BP
	MOVB BP, (AX)
	MOVW SI, 1(AX)
...
search_loop_encodeBetterBlockAsm4MB:
	...
	SHRQ  $0x08, R9
	CMPL  R9, R10
	JNE   no_repeat_found_encodeBetterBlockAsm4MB
	LEAL  1(CX), SI
	MOVL  12(SP), DI
	MOVL  SI, BP
	SUBL  16(SP), BP
	JZ    repeat_extend_back_end_encodeBetterBlockAsm4MB

repeat_extend_back_loop_encodeBetterBlockAsm4MB:
	CMPL SI, DI
	JLE  repeat_extend_back_end_encodeBetterBlockAsm4MB
	MOVB -1(DX)(BP*1), BL
	MOVB -1(DX)(SI*1), R8
	CMPB BL, R8
	JNE  repeat_extend_back_end_encodeBetterBlockAsm4MB
	LEAL -1(SI), SI
	DECL BP
	JNZ  repeat_extend_back_loop_encodeBetterBlockAsm4MB

repeat_extend_back_end_encodeBetterBlockAsm4MB:
	MOVL 12(SP), BP
	CMPL BP, SI
	JEQ  emit_literal_done_repeat_emit_encodeBetterBlockAsm4MB
	MOVL SI, R8
	MOVL SI, 12(SP)
	LEAQ (DX)(BP*1), R9
	SUBL BP, R8
	...
	CMPL BP, $0x00000100
	JLT  two_bytes_repeat_emit_encodeBetterBlockAsm4MB
	CMPL BP, $0x00010000
	...
	MOVB R10, 3(AX)
	ADDQ $0x04, AX
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm4MB

three_bytes_repeat_emit_encodeBetterBlockAsm4MB:
	MOVB $0xf4, (AX)
	MOVW BP, 1(AX)
	ADDQ $0x03, AX
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm4MB
...
two_bytes_repeat_emit_encodeBetterBlockAsm4MB:
	...
	ADDQ $0x02, AX
	CMPL BP, $0x40
	JL   memmove_repeat_emit_encodeBetterBlockAsm4MB
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm4MB

one_byte_repeat_emit_encodeBetterBlockAsm4MB:
	SHLB $0x02, BP
	MOVB BP, (AX)
	ADDQ $0x01, AX

memmove_repeat_emit_encodeBetterBlockAsm4MB:
	LEAQ (AX)(R8*1), BP
	...
	CMPQ R8, $0x08
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_4through7
	CMPQ R8, $0x10
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_8through16
	CMPQ R8, $0x20
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_17through32
	JMP  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_33through64
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_1or2:
	...
	MOVB R10, (AX)
	MOVB R9, -1(AX)(R8*1)
	JMP  memmove_end_copy_repeat_emit_encodeBetterBlockAsm4MB

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_3:
	MOVW (R9), R10
	MOVB 2(R9), R9
	MOVW R10, (AX)
	MOVB R9, 2(AX)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_4through7:
	MOVL (R9), R10
	MOVL -4(R9)(R8*1), R9
	MOVL R10, (AX)
	MOVL R9, -4(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm4MB_memmove_move_17through32:
	MOVOU (R9), X0
	MOVOU -16(R9)(R8*1), X1
	MOVOU X0, (AX)
	MOVOU X1, -16(AX)(R8*1)
...
memmove_end_copy_repeat_emit_encodeBetterBlockAsm4MB:
	MOVQ BP, AX
	JMP  emit_literal_done_repeat_emit_encodeBetterBlockAsm4MB

memmove_long_repeat_emit_encodeBetterBlockAsm4MB:
	LEAQ (AX)(R8*1), BP
	...
	SUBQ  R10, R12
	DECQ  R11
	JA    emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm4MBlarge_forward_sse_loop_32
	LEAQ  -32(R9)(R12*1), R10
	LEAQ  -32(AX)(R12*1), R13

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm4MBlarge_big_loop_back:
	MOVOU (R10), X4
	MOVOU 16(R10), X5
	MOVOA X4, (R13)
	MOVOA X5, 16(R13)
	...
	ADDQ  $0x20, R12
	DECQ  R11
	JNA   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm4MBlarge_big_loop_back

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm4MBlarge_forward_sse_loop_32:
	MOVOU -32(R9)(R12*1), X4
	MOVOU -16(R9)(R12*1), X5
	MOVOA X4, -32(AX)(R12*1)
	MOVOA X5, -16(AX)(R12*1)
...
emit_literal_done_repeat_emit_encodeBetterBlockAsm4MB:
	ADDL $0x05, CX
	MOVL CX, BP
	SUBL 16(SP), BP
	MOVQ src_len+32(FP), R8
	...
	XORL R11, R11
	CMPL R8, $0x08
	JL   matchlen_single_repeat_extend_encodeBetterBlockAsm4MB

matchlen_loopback_repeat_extend_encodeBetterBlockAsm4MB:
	MOVQ  (R9)(R11*1), R10
	XORQ  (BP)(R11*1), R10
	TESTQ R10, R10
	JZ    matchlen_loop_repeat_extend_encodeBetterBlockAsm4MB
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R11)(R10*1), R11
	JMP   repeat_extend_forward_end_encodeBetterBlockAsm4MB

matchlen_loop_repeat_extend_encodeBetterBlockAsm4MB:
	LEAL -8(R8), R8
	LEAL 8(R11), R11
	CMPL R8, $0x08
	JGE  matchlen_loopback_repeat_extend_encodeBetterBlockAsm4MB

matchlen_single_repeat_extend_encodeBetterBlockAsm4MB:
	TESTL R8, R8
	JZ    repeat_extend_forward_end_encodeBetterBlockAsm4MB

matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm4MB:
	MOVB (R9)(R11*1), R10
	CMPB (BP)(R11*1), R10
	JNE  repeat_extend_forward_end_encodeBetterBlockAsm4MB
	LEAL 1(R11), R11
	DECL R8
	JNZ  matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm4MB
...
repeat_extend_forward_end_encodeBetterBlockAsm4MB:
	...
	MOVL  16(SP), SI
	TESTL DI, DI
	JZ    repeat_as_copy_encodeBetterBlockAsm4MB

	// emitRepeat
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_match_repeat_encodeBetterBlockAsm4MB
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm4MB
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_match_repeat_encodeBetterBlockAsm4MB

cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm4MB:
	CMPL BP, $0x00000104
	JLT  repeat_three_match_repeat_encodeBetterBlockAsm4MB
	CMPL BP, $0x00010100
	JLT  repeat_four_match_repeat_encodeBetterBlockAsm4MB
	LEAL -65536(BP), BP
	MOVL BP, SI
	MOVW $0x001d, (AX)
	MOVW BP, 2(AX)
	...
	MOVB SI, 4(AX)
	ADDQ $0x05, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm4MB

repeat_four_match_repeat_encodeBetterBlockAsm4MB:
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_two_match_repeat_encodeBetterBlockAsm4MB:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
repeat_as_copy_encodeBetterBlockAsm4MB:
	// emitCopy
	CMPL SI, $0x00010000
	JL   two_byte_offset_repeat_as_copy_encodeBetterBlockAsm4MB

four_bytes_loop_back_repeat_as_copy_encodeBetterBlockAsm4MB:
	CMPL BP, $0x40
	JLE  four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm4MB
	MOVB $0xff, (AX)
	MOVL SI, 1(AX)
	LEAL -64(BP), BP
	ADDQ $0x05, AX
	CMPL BP, $0x04
	JL   four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm4MB

	// emitRepeat
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy
	CMPL BP, $0x00010100
	JLT  repeat_four_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy
	LEAL -65536(BP), BP
	MOVL BP, SI
	MOVW $0x001d, (AX)
	MOVW BP, 2(AX)
...
repeat_four_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy:
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_two_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy:
	XORQ DI, DI
	LEAL 1(DI)(BP*4), BP
	MOVB SI, 1(AX)
	SARL $0x08, SI
	...
	ADDQ $0x02, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm4MB
	JMP four_bytes_loop_back_repeat_as_copy_encodeBetterBlockAsm4MB

four_bytes_remain_repeat_as_copy_encodeBetterBlockAsm4MB:
	TESTL BP, BP
	JZ    repeat_end_emit_encodeBetterBlockAsm4MB
	MOVB  $0x03, BL
	LEAL  -4(BX)(BP*4), BP
	MOVB  BP, (AX)
	MOVL  SI, 1(AX)
...
two_byte_offset_repeat_as_copy_encodeBetterBlockAsm4MB:
	CMPL BP, $0x40
	JLE  two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm4MB
	MOVB $0xee, (AX)
	MOVW SI, 1(AX)
	LEAL -60(BP), BP
	ADDQ $0x03, AX
	...
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short
	CMPL BP, $0x00010100
	JLT  repeat_four_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short
	LEAL -65536(BP), BP
	MOVL BP, SI
	MOVW $0x001d, (AX)
	MOVW BP, 2(AX)
...
repeat_four_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short:
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_three_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short:
	LEAL -4(BP), BP
	MOVW $0x0015, (AX)
	MOVB BP, 2(AX)
	ADDQ $0x03, AX
...
repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm4MB_emit_copy_short:
	XORQ DI, DI
	LEAL 1(DI)(BP*4), BP
	MOVB SI, 1(AX)
	SARL $0x08, SI
	...
	ADDQ $0x02, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm4MB
	JMP two_byte_offset_repeat_as_copy_encodeBetterBlockAsm4MB

two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm4MB:
	CMPL BP, $0x0c
	JGE  emit_copy_three_repeat_as_copy_encodeBetterBlockAsm4MB
	CMPL SI, $0x00000800
	JGE  emit_copy_three_repeat_as_copy_encodeBetterBlockAsm4MB
	MOVB $0x01, BL
	LEAL -16(BX)(BP*4), BP
...
repeat_end_emit_encodeBetterBlockAsm4MB:
	MOVL CX, 12(SP)
	JMP  search_loop_encodeBetterBlockAsm4MB

no_repeat_found_encodeBetterBlockAsm4MB:
	CMPL (DX)(BP*1), SI
...
search_loop_encodeBetterBlockAsm12B:
	...
	MOVL  SI, BP
	SUBL  16(SP), BP
	JZ    repeat_extend_back_end_encodeBetterBlockAsm12B

repeat_extend_back_loop_encodeBetterBlockAsm12B:
	CMPL SI, DI
	JLE  repeat_extend_back_end_encodeBetterBlockAsm12B
	MOVB -1(DX)(BP*1), BL
	MOVB -1(DX)(SI*1), R8
	CMPB BL, R8
	JNE  repeat_extend_back_end_encodeBetterBlockAsm12B
	LEAL -1(SI), SI
	DECL BP
	JNZ  repeat_extend_back_loop_encodeBetterBlockAsm12B

repeat_extend_back_end_encodeBetterBlockAsm12B:
	MOVL 12(SP), BP
	CMPL BP, SI
	JEQ  emit_literal_done_repeat_emit_encodeBetterBlockAsm12B
	MOVL SI, R8
	MOVL SI, 12(SP)
	LEAQ (DX)(BP*1), R9
	SUBL BP, R8
	LEAL -1(R8), BP
	CMPL BP, $0x3c
	JLT  one_byte_repeat_emit_encodeBetterBlockAsm12B
	CMPL BP, $0x00000100
	JLT  two_bytes_repeat_emit_encodeBetterBlockAsm12B
	MOVB $0xf4, (AX)
	MOVW BP, 1(AX)
	ADDQ $0x03, AX
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm12B

two_bytes_repeat_emit_encodeBetterBlockAsm12B:
	MOVB $0xf0, (AX)
	MOVB BP, 1(AX)
	ADDQ $0x02, AX
	CMPL BP, $0x40
	JL   memmove_repeat_emit_encodeBetterBlockAsm12B
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm12B

one_byte_repeat_emit_encodeBetterBlockAsm12B:
	SHLB $0x02, BP
	MOVB BP, (AX)
	ADDQ $0x01, AX
...
memmove_repeat_emit_encodeBetterBlockAsm12B:
	...
	// genMemMoveShort
	CMPQ R8, $0x03
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_1or2
	JE   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_3
	CMPQ R8, $0x08
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_4through7
	CMPQ R8, $0x10
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_8through16
	CMPQ R8, $0x20
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_17through32
	JMP  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_33through64

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_1or2:
	MOVB (R9), R10
	MOVB -1(R9)(R8*1), R9
	MOVB R10, (AX)
	MOVB R9, -1(AX)(R8*1)
	JMP  memmove_end_copy_repeat_emit_encodeBetterBlockAsm12B

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_3:
	MOVW (R9), R10
	MOVB 2(R9), R9
	MOVW R10, (AX)
	MOVB R9, 2(AX)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_4through7:
	MOVL (R9), R10
	MOVL -4(R9)(R8*1), R9
	MOVL R10, (AX)
	MOVL R9, -4(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_8through16:
	MOVQ (R9), R10
	MOVQ -8(R9)(R8*1), R9
	MOVQ R10, (AX)
	MOVQ R9, -8(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_17through32:
	MOVOU (R9), X0
	MOVOU -16(R9)(R8*1), X1
	MOVOU X0, (AX)
	MOVOU X1, -16(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm12B_memmove_move_33through64:
	MOVOU (R9), X0
	MOVOU 16(R9), X1
	MOVOU -32(R9)(R8*1), X2
	MOVOU -16(R9)(R8*1), X3
...
memmove_end_copy_repeat_emit_encodeBetterBlockAsm12B:
	MOVQ BP, AX
	JMP  emit_literal_done_repeat_emit_encodeBetterBlockAsm12B

memmove_long_repeat_emit_encodeBetterBlockAsm12B:
	LEAQ (AX)(R8*1), BP
	...
	SUBQ  R10, R12
	DECQ  R11
	JA    emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm12Blarge_forward_sse_loop_32
	LEAQ  -32(R9)(R12*1), R10
	LEAQ  -32(AX)(R12*1), R13

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm12Blarge_big_loop_back:
	MOVOU (R10), X4
	MOVOU 16(R10), X5
	MOVOA X4, (R13)
	MOVOA X5, 16(R13)
	...
	ADDQ  $0x20, R12
	DECQ  R11
	JNA   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm12Blarge_big_loop_back
...
emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm12Blarge_forward_sse_loop_32:
	...
	ADDQ  $0x20, R12
	CMPQ  R8, R12
	JAE   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm12Blarge_forward_sse_loop_32
	MOVOU X0, (AX)
	MOVOU X1, 16(AX)
	MOVOU X2, -32(AX)(R8*1)
	MOVOU X3, -16(AX)(R8*1)
...
emit_literal_done_repeat_emit_encodeBetterBlockAsm12B:
	ADDL $0x05, CX
	MOVL CX, BP
	SUBL 16(SP), BP
	MOVQ src_len+32(FP), R8
	...
	XORL R11, R11
	CMPL R8, $0x08
	JL   matchlen_single_repeat_extend_encodeBetterBlockAsm12B

matchlen_loopback_repeat_extend_encodeBetterBlockAsm12B:
	MOVQ  (R9)(R11*1), R10
	XORQ  (BP)(R11*1), R10
	TESTQ R10, R10
	JZ    matchlen_loop_repeat_extend_encodeBetterBlockAsm12B
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R11)(R10*1), R11
	JMP   repeat_extend_forward_end_encodeBetterBlockAsm12B

matchlen_loop_repeat_extend_encodeBetterBlockAsm12B:
	LEAL -8(R8), R8
	LEAL 8(R11), R11
	CMPL R8, $0x08
	JGE  matchlen_loopback_repeat_extend_encodeBetterBlockAsm12B

matchlen_single_repeat_extend_encodeBetterBlockAsm12B:
	TESTL R8, R8
	JZ    repeat_extend_forward_end_encodeBetterBlockAsm12B

matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm12B:
	MOVB (R9)(R11*1), R10
	CMPB (BP)(R11*1), R10
	JNE  repeat_extend_forward_end_encodeBetterBlockAsm12B
	LEAL 1(R11), R11
	DECL R8
	JNZ  matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm12B
...
repeat_extend_forward_end_encodeBetterBlockAsm12B:
	...
	MOVL  16(SP), SI
	TESTL DI, DI
	JZ    repeat_as_copy_encodeBetterBlockAsm12B

	// emitRepeat
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_match_repeat_encodeBetterBlockAsm12B
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm12B
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_match_repeat_encodeBetterBlockAsm12B

cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm12B:
	CMPL BP, $0x00000104
	JLT  repeat_three_match_repeat_encodeBetterBlockAsm12B
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm12B
...
repeat_as_copy_encodeBetterBlockAsm12B:
	// emitCopy
two_byte_offset_repeat_as_copy_encodeBetterBlockAsm12B:
	CMPL BP, $0x40
	JLE  two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm12B
	MOVB $0xee, (AX)
	MOVW SI, 1(AX)
	LEAL -60(BP), BP
	ADDQ $0x03, AX
	...
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_two_repeat_as_copy_encodeBetterBlockAsm12B_emit_copy_short:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
emit_copy_three_repeat_as_copy_encodeBetterBlockAsm12B:
	MOVB $0x02, BL
	LEAL -4(BX)(BP*4), BP
	MOVB BP, (AX)
	MOVW SI, 1(AX)
...
repeat_end_emit_encodeBetterBlockAsm12B:
	MOVL CX, 12(SP)
...
search_loop_encodeBetterBlockAsm10B:
	...
	SHRQ  $0x08, R9
	CMPL  R9, R10
	JNE   no_repeat_found_encodeBetterBlockAsm10B
	LEAL  1(CX), SI
	MOVL  12(SP), DI
	MOVL  SI, BP
	SUBL  16(SP), BP
	JZ    repeat_extend_back_end_encodeBetterBlockAsm10B

repeat_extend_back_loop_encodeBetterBlockAsm10B:
	CMPL SI, DI
	JLE  repeat_extend_back_end_encodeBetterBlockAsm10B
	MOVB -1(DX)(BP*1), BL
	MOVB -1(DX)(SI*1), R8
	CMPB BL, R8
	JNE  repeat_extend_back_end_encodeBetterBlockAsm10B
	LEAL -1(SI), SI
	DECL BP
	JNZ  repeat_extend_back_loop_encodeBetterBlockAsm10B

repeat_extend_back_end_encodeBetterBlockAsm10B:
	MOVL 12(SP), BP
	CMPL BP, SI
	JEQ  emit_literal_done_repeat_emit_encodeBetterBlockAsm10B
	MOVL SI, R8
	MOVL SI, 12(SP)
	LEAQ (DX)(BP*1), R9
	SUBL BP, R8
	LEAL -1(R8), BP
	CMPL BP, $0x3c
	JLT  one_byte_repeat_emit_encodeBetterBlockAsm10B
	CMPL BP, $0x00000100
	JLT  two_bytes_repeat_emit_encodeBetterBlockAsm10B
	MOVB $0xf4, (AX)
	MOVW BP, 1(AX)
	ADDQ $0x03, AX
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm10B
...
two_bytes_repeat_emit_encodeBetterBlockAsm10B:
	...
	ADDQ $0x02, AX
	CMPL BP, $0x40
	JL   memmove_repeat_emit_encodeBetterBlockAsm10B
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm10B

one_byte_repeat_emit_encodeBetterBlockAsm10B:
	SHLB $0x02, BP
	MOVB BP, (AX)
	ADDQ $0x01, AX

memmove_repeat_emit_encodeBetterBlockAsm10B:
	LEAQ (AX)(R8*1), BP

	// genMemMoveShort
	CMPQ R8, $0x03
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_1or2
	JE   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_3
	CMPQ R8, $0x08
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_4through7
	CMPQ R8, $0x10
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_8through16
	CMPQ R8, $0x20
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_17through32
	JMP  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_33through64
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_1or2:
	...
	MOVB R10, (AX)
	MOVB R9, -1(AX)(R8*1)
	JMP  memmove_end_copy_repeat_emit_encodeBetterBlockAsm10B

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_3:
	MOVW (R9), R10
	MOVB 2(R9), R9
	MOVW R10, (AX)
	MOVB R9, 2(AX)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_4through7:
	MOVL (R9), R10
	MOVL -4(R9)(R8*1), R9
	MOVL R10, (AX)
	MOVL R9, -4(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_8through16:
	MOVQ (R9), R10
	MOVQ -8(R9)(R8*1), R9
	MOVQ R10, (AX)
	MOVQ R9, -8(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_17through32:
	MOVOU (R9), X0
	MOVOU -16(R9)(R8*1), X1
	MOVOU X0, (AX)
	MOVOU X1, -16(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm10B_memmove_move_33through64:
	MOVOU (R9), X0
	MOVOU 16(R9), X1
	MOVOU -32(R9)(R8*1), X2
	MOVOU -16(R9)(R8*1), X3
...
memmove_end_copy_repeat_emit_encodeBetterBlockAsm10B:
	MOVQ BP, AX
	JMP  emit_literal_done_repeat_emit_encodeBetterBlockAsm10B

memmove_long_repeat_emit_encodeBetterBlockAsm10B:
	LEAQ (AX)(R8*1), BP
	...
	SUBQ  R10, R12
	DECQ  R11
	JA    emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm10Blarge_forward_sse_loop_32
	LEAQ  -32(R9)(R12*1), R10
	LEAQ  -32(AX)(R12*1), R13

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm10Blarge_big_loop_back:
	MOVOU (R10), X4
	MOVOU 16(R10), X5
	MOVOA X4, (R13)
	MOVOA X5, 16(R13)
	...
	ADDQ  $0x20, R12
	DECQ  R11
	JNA   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm10Blarge_big_loop_back
...
emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm10Blarge_forward_sse_loop_32:
	...
	ADDQ  $0x20, R12
	CMPQ  R8, R12
	JAE   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm10Blarge_forward_sse_loop_32
	MOVOU X0, (AX)
	MOVOU X1, 16(AX)
	MOVOU X2, -32(AX)(R8*1)
	MOVOU X3, -16(AX)(R8*1)
...
emit_literal_done_repeat_emit_encodeBetterBlockAsm10B:
	ADDL $0x05, CX
	MOVL CX, BP
	SUBL 16(SP), BP
	MOVQ src_len+32(FP), R8
	...
	XORL R11, R11
	CMPL R8, $0x08
	JL   matchlen_single_repeat_extend_encodeBetterBlockAsm10B

matchlen_loopback_repeat_extend_encodeBetterBlockAsm10B:
	MOVQ  (R9)(R11*1), R10
	XORQ  (BP)(R11*1), R10
	TESTQ R10, R10
	JZ    matchlen_loop_repeat_extend_encodeBetterBlockAsm10B
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R11)(R10*1), R11
	JMP   repeat_extend_forward_end_encodeBetterBlockAsm10B

matchlen_loop_repeat_extend_encodeBetterBlockAsm10B:
	LEAL -8(R8), R8
	LEAL 8(R11), R11
	CMPL R8, $0x08
	JGE  matchlen_loopback_repeat_extend_encodeBetterBlockAsm10B
...
matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm10B:
	MOVB (R9)(R11*1), R10
	CMPB (BP)(R11*1), R10
	JNE  repeat_extend_forward_end_encodeBetterBlockAsm10B
	LEAL 1(R11), R11
	DECL R8
	JNZ  matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm10B

repeat_extend_forward_end_encodeBetterBlockAsm10B:
	ADDL  R11, CX
	MOVL  CX, BP
	SUBL  SI, BP
	MOVL  16(SP), SI
	TESTL DI, DI
	JZ    repeat_as_copy_encodeBetterBlockAsm10B

	// emitRepeat
	MOVL BP, DI
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_match_repeat_encodeBetterBlockAsm10B
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm10B
	CMPL SI, $0x00000800
	JLT  repeat_two_offset_match_repeat_encodeBetterBlockAsm10B

cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm10B:
	CMPL BP, $0x00000104
	JLT  repeat_three_match_repeat_encodeBetterBlockAsm10B
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm10B
...
repeat_two_match_repeat_encodeBetterBlockAsm10B:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
repeat_two_offset_match_repeat_encodeBetterBlockAsm10B:
	XORQ DI, DI
	LEAL 1(DI)(BP*4), BP
	MOVB SI, 1(AX)
	SARL $0x08, SI
...
repeat_as_copy_encodeBetterBlockAsm10B:
	// emitCopy
two_byte_offset_repeat_as_copy_encodeBetterBlockAsm10B:
	CMPL BP, $0x40
	...
	LEAL -4(BP), BP
	CMPL DI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short
	CMPL DI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short
	CMPL SI, $0x00000800
...
cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_two_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm10B_emit_copy_short:
	XORQ DI, DI
	LEAL 1(DI)(BP*4), BP
	MOVB SI, 1(AX)
	SARL $0x08, SI
	...
	ADDQ $0x02, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm10B
	JMP two_byte_offset_repeat_as_copy_encodeBetterBlockAsm10B

two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm10B:
	CMPL BP, $0x0c
...
emit_copy_three_repeat_as_copy_encodeBetterBlockAsm10B:
	MOVB $0x02, BL
	LEAL -4(BX)(BP*4), BP
	MOVB BP, (AX)
	MOVW SI, 1(AX)
...
repeat_end_emit_encodeBetterBlockAsm10B:
	MOVL CX, 12(SP)
...
search_loop_encodeBetterBlockAsm8B:
	...
	SHRQ  $0x08, R9
	CMPL  R9, R10
	JNE   no_repeat_found_encodeBetterBlockAsm8B
	LEAL  1(CX), SI
	MOVL  12(SP), DI
	MOVL  SI, BP
	SUBL  16(SP), BP
	JZ    repeat_extend_back_end_encodeBetterBlockAsm8B

repeat_extend_back_loop_encodeBetterBlockAsm8B:
	CMPL SI, DI
	JLE  repeat_extend_back_end_encodeBetterBlockAsm8B
	MOVB -1(DX)(BP*1), BL
	MOVB -1(DX)(SI*1), R8
	CMPB BL, R8
	JNE  repeat_extend_back_end_encodeBetterBlockAsm8B
	LEAL -1(SI), SI
	DECL BP
	JNZ  repeat_extend_back_loop_encodeBetterBlockAsm8B

repeat_extend_back_end_encodeBetterBlockAsm8B:
	MOVL 12(SP), BP
	CMPL BP, SI
	JEQ  emit_literal_done_repeat_emit_encodeBetterBlockAsm8B
	MOVL SI, R8
	MOVL SI, 12(SP)
	LEAQ (DX)(BP*1), R9
	SUBL BP, R8
	...
	CMPL BP, $0x00000100
	JLT  two_bytes_repeat_emit_encodeBetterBlockAsm8B
	MOVB $0xf4, (AX)
	MOVW BP, 1(AX)
	ADDQ $0x03, AX
...
two_bytes_repeat_emit_encodeBetterBlockAsm8B:
	...
	ADDQ $0x02, AX
	CMPL BP, $0x40
	JL   memmove_repeat_emit_encodeBetterBlockAsm8B
	JMP  memmove_long_repeat_emit_encodeBetterBlockAsm8B
...
memmove_repeat_emit_encodeBetterBlockAsm8B:
	LEAQ (AX)(R8*1), BP

	// genMemMoveShort
	CMPQ R8, $0x03
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_1or2
	JE   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_3
	CMPQ R8, $0x08
	JB   emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_4through7
	CMPQ R8, $0x10
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_8through16
	CMPQ R8, $0x20
	JBE  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_17through32
	JMP  emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_33through64

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_1or2:
	MOVB (R9), R10
	MOVB -1(R9)(R8*1), R9
	MOVB R10, (AX)
	MOVB R9, -1(AX)(R8*1)
	JMP  memmove_end_copy_repeat_emit_encodeBetterBlockAsm8B

emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_3:
	MOVW (R9), R10
	MOVB 2(R9), R9
	MOVW R10, (AX)
	MOVB R9, 2(AX)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_4through7:
	MOVL (R9), R10
	MOVL -4(R9)(R8*1), R9
	MOVL R10, (AX)
	MOVL R9, -4(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_8through16:
	MOVQ (R9), R10
	MOVQ -8(R9)(R8*1), R9
	MOVQ R10, (AX)
	MOVQ R9, -8(AX)(R8*1)
...
emit_lit_memmove_repeat_emit_encodeBetterBlockAsm8B_memmove_move_17through32:
	MOVOU (R9), X0
	MOVOU -16(R9)(R8*1), X1
	MOVOU X0, (AX)
	MOVOU X1, -16(AX)(R8*1)
...
memmove_end_copy_repeat_emit_encodeBetterBlockAsm8B:
	MOVQ BP, AX
	JMP  emit_literal_done_repeat_emit_encodeBetterBlockAsm8B

memmove_long_repeat_emit_encodeBetterBlockAsm8B:
	LEAQ (AX)(R8*1), BP
	...
	SUBQ  R10, R12
	DECQ  R11
	JA    emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm8Blarge_forward_sse_loop_32
	LEAQ  -32(R9)(R12*1), R10
	LEAQ  -32(AX)(R12*1), R13

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm8Blarge_big_loop_back:
	MOVOU (R10), X4
	MOVOU 16(R10), X5
	MOVOA X4, (R13)
	MOVOA X5, 16(R13)
	...
	ADDQ  $0x20, R12
	DECQ  R11
	JNA   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm8Blarge_big_loop_back

emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm8Blarge_forward_sse_loop_32:
	MOVOU -32(R9)(R12*1), X4
	MOVOU -16(R9)(R12*1), X5
	MOVOA X4, -32(AX)(R12*1)
	MOVOA X5, -16(AX)(R12*1)
	ADDQ  $0x20, R12
	CMPQ  R8, R12
	JAE   emit_lit_memmove_long_repeat_emit_encodeBetterBlockAsm8Blarge_forward_sse_loop_32
	MOVOU X0, (AX)
	MOVOU X1, 16(AX)
	MOVOU X2, -32(AX)(R8*1)
	MOVOU X3, -16(AX)(R8*1)
...
emit_literal_done_repeat_emit_encodeBetterBlockAsm8B:
	...
	XORL R11, R11
	CMPL R8, $0x08
	JL   matchlen_single_repeat_extend_encodeBetterBlockAsm8B

matchlen_loopback_repeat_extend_encodeBetterBlockAsm8B:
	MOVQ  (R9)(R11*1), R10
	XORQ  (BP)(R11*1), R10
	TESTQ R10, R10
	JZ    matchlen_loop_repeat_extend_encodeBetterBlockAsm8B
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R11)(R10*1), R11
	JMP   repeat_extend_forward_end_encodeBetterBlockAsm8B

matchlen_loop_repeat_extend_encodeBetterBlockAsm8B:
	LEAL -8(R8), R8
	LEAL 8(R11), R11
	CMPL R8, $0x08
	JGE  matchlen_loopback_repeat_extend_encodeBetterBlockAsm8B

matchlen_single_repeat_extend_encodeBetterBlockAsm8B:
	TESTL R8, R8
...
matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm8B:
	MOVB (R9)(R11*1), R10
	CMPB (BP)(R11*1), R10
	JNE  repeat_extend_forward_end_encodeBetterBlockAsm8B
	LEAL 1(R11), R11
	DECL R8
	JNZ  matchlen_single_loopback_repeat_extend_encodeBetterBlockAsm8B
...
repeat_extend_forward_end_encodeBetterBlockAsm8B:
	...
	MOVL  16(SP), SI
	TESTL DI, DI
	JZ    repeat_as_copy_encodeBetterBlockAsm8B

	// emitRepeat
	MOVL BP, SI
	LEAL -4(BP), BP
	CMPL SI, $0x08
	JLE  repeat_two_match_repeat_encodeBetterBlockAsm8B
	CMPL SI, $0x0c
	JGE  cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm8B

cant_repeat_two_offset_match_repeat_encodeBetterBlockAsm8B:
	CMPL BP, $0x00000104
	JLT  repeat_three_match_repeat_encodeBetterBlockAsm8B
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm8B

repeat_three_match_repeat_encodeBetterBlockAsm8B:
	LEAL -4(BP), BP
	MOVW $0x0015, (AX)
	MOVB BP, 2(AX)
	ADDQ $0x03, AX
...
repeat_two_match_repeat_encodeBetterBlockAsm8B:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
...
repeat_as_copy_encodeBetterBlockAsm8B:
	// emitCopy
two_byte_offset_repeat_as_copy_encodeBetterBlockAsm8B:
	CMPL BP, $0x40
	...
	LEAL -4(BP), BP
	CMPL SI, $0x08
	JLE  repeat_two_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short
	CMPL SI, $0x0c
	JGE  cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short

cant_repeat_two_offset_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short:
	CMPL BP, $0x00000104
	JLT  repeat_three_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short
	LEAL -256(BP), BP
	MOVW $0x0019, (AX)
	MOVW BP, 2(AX)
	ADDQ $0x04, AX
...
repeat_three_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short:
	LEAL -4(BP), BP
	MOVW $0x0015, (AX)
	MOVB BP, 2(AX)
	ADDQ $0x03, AX
...
repeat_two_repeat_as_copy_encodeBetterBlockAsm8B_emit_copy_short:
	SHLL $0x02, BP
	ORL  $0x01, BP
	MOVW BP, (AX)
	ADDQ $0x02, AX
	...
	ADDQ $0x02, AX
	JMP  repeat_end_emit_encodeBetterBlockAsm8B
	JMP two_byte_offset_repeat_as_copy_encodeBetterBlockAsm8B

two_byte_offset_short_repeat_as_copy_encodeBetterBlockAsm8B:
	CMPL BP, $0x0c
	JGE  emit_copy_three_repeat_as_copy_encodeBetterBlockAsm8B
	MOVB $0x01, BL
	LEAL -16(BX)(BP*4), BP
	MOVB SI, 1(AX)
	SHRL $0x08, SI
...
emit_copy_three_repeat_as_copy_encodeBetterBlockAsm8B:
	MOVB $0x02, BL
	LEAL -4(BX)(BP*4), BP
	MOVB BP, (AX)
	MOVW SI, 1(AX)
...
repeat_end_emit_encodeBetterBlockAsm8B:
	MOVL CX, 12(SP)
	JMP  search_loop_encodeBetterBlockAsm8B

no_repeat_found_encodeBetterBlockAsm8B:
	CMPL (DX)(BP*1), SI
