...
zero_loop_encodeBlockAsm:
	...
	JL    assert_check_0_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_0_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_1_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_1_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeBlockAsm:
	...
	CMPQ BP, DX
	JEQ  assert_check_2_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_2_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_3_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_3_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x06, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00010000
	JL    assert_check_4_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_4_ok_srcline_258:
	CMPQ R10, $0x00010000
	JL   assert_check_5_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_5_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x32, R9
	CMPQ  R9, $0x00010000
	JL    assert_check_6_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_6_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeBlockAsm:
	...
	SUBL  BP, R8
	TESTL R8, R8
	JNZ   assert_check_7_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_7_ok_srcline_841:
	LEAL -1(R8), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeBlockAsm:
	...
	SUBL CX, R8
	CMPQ R8, $0x7fffffff
	JL   assert_check_8_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_8_ok_srcline_357:
	LEAQ (DX)(CX*1), R9
	LEAQ (DX)(BP*1), BP
	XORL R12, R12
	CMPL R8, $0x10
	JL   matchlen_four_repeat_extend
...
matchlen_loopback_repeat_extend:
	...
	XORQ  8(BP), R11
	TESTQ R10, R10
	JZ    matchlen_loop_tmp2_repeat_extend
	BSFQ  R10, R10
	SARQ  $0x03, R10
	LEAL  (R12)(R10*1), R12
	JMP   repeat_extend_forward_end_encodeBlockAsm

matchlen_loop_tmp2_repeat_extend:
	TESTQ R11, R11
	JZ    matchlen_loop_repeat_extend
	BSFQ  R11, R11
	SARQ  $0x03, R11
	LEAL  8(R12)(R11*1), R12
	JMP   repeat_extend_forward_end_encodeBlockAsm
...
no_repeat_found_encodeBlockAsm:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_9_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_9_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_10_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_10_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_11_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_11_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_12_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_12_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_13_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_13_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_14_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_14_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeBlockAsm:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_15_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_15_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeBlockAsm:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_16_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_16_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_17_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_17_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeBlockAsm
...
matchlen_loopback_match_nolit_encodeBlockAsm:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeBlockAsm
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeBlockAsm

matchlen_loop_tmp2_match_nolit_encodeBlockAsm:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeBlockAsm:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeBlockAsm:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00010000
	JL    assert_check_18_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_18_ok_srcline_624:
	CMPQ R8, $0x00010000
	JL   assert_check_19_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_19_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeBlockAsm:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_20_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_20_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeBlockAsm:
	CMPQ AX, (SP)
	JL   assert_check_21_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_21_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_22_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_22_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_23_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_23_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeBlockAsm12B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_24_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_24_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_25_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_25_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeBlockAsm12B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_26_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_26_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_27_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_27_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x05, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00004000
	JL    assert_check_28_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_28_ok_srcline_258:
	CMPQ R10, $0x00004000
	JL   assert_check_29_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_29_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x34, R9
	CMPQ  R9, $0x00004000
	JL    assert_check_30_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_30_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeBlockAsm12B:
	...
	SUBL  BP, R8
	TESTL R8, R8
	JNZ   assert_check_31_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_31_ok_srcline_841:
	LEAL -1(R8), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeBlockAsm12B:
	...
	SUBL CX, R8
	CMPQ R8, $0x7fffffff
	JL   assert_check_32_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_32_ok_srcline_357:
	LEAQ (DX)(CX*1), R9
	LEAQ (DX)(BP*1), BP
	XORL R12, R12
	CMPL R8, $0x10
...
no_repeat_found_encodeBlockAsm12B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_33_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_33_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_34_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_34_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_35_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_35_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_36_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_36_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_37_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_37_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_38_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_38_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeBlockAsm12B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_39_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_39_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeBlockAsm12B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_40_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_40_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_41_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_41_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeBlockAsm12B
...
matchlen_loopback_match_nolit_encodeBlockAsm12B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeBlockAsm12B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeBlockAsm12B

matchlen_loop_tmp2_match_nolit_encodeBlockAsm12B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeBlockAsm12B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeBlockAsm12B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00004000
	JL    assert_check_42_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_42_ok_srcline_624:
	CMPQ R8, $0x00004000
	JL   assert_check_43_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_43_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeBlockAsm12B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_44_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_44_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeBlockAsm12B:
	CMPQ AX, (SP)
	JL   assert_check_45_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_45_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_46_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_46_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_47_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_47_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeBlockAsm10B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_48_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_48_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_49_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_49_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeBlockAsm10B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_50_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_50_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_51_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_51_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x05, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00001000
	JL    assert_check_52_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_52_ok_srcline_258:
	CMPQ R10, $0x00001000
	JL   assert_check_53_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_53_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x36, R9
	CMPQ  R9, $0x00001000
	JL    assert_check_54_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_54_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeBlockAsm10B:
	...
	SUBL  BP, R8
	TESTL R8, R8
	JNZ   assert_check_55_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_55_ok_srcline_841:
	LEAL -1(R8), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeBlockAsm10B:
	...
	SUBL CX, R8
	CMPQ R8, $0x7fffffff
	JL   assert_check_56_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_56_ok_srcline_357:
	LEAQ (DX)(CX*1), R9
	LEAQ (DX)(BP*1), BP
	XORL R12, R12
	CMPL R8, $0x10
...
no_repeat_found_encodeBlockAsm10B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_57_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_57_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_58_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_58_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_59_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_59_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_60_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_60_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_61_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_61_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_62_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_62_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeBlockAsm10B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_63_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_63_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeBlockAsm10B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_64_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_64_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_65_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_65_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeBlockAsm10B
...
matchlen_loopback_match_nolit_encodeBlockAsm10B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeBlockAsm10B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeBlockAsm10B

matchlen_loop_tmp2_match_nolit_encodeBlockAsm10B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeBlockAsm10B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeBlockAsm10B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00001000
	JL    assert_check_66_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_66_ok_srcline_624:
	CMPQ R8, $0x00001000
	JL   assert_check_67_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_67_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeBlockAsm10B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_68_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_68_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeBlockAsm10B:
	CMPQ AX, (SP)
	JL   assert_check_69_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_69_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_70_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_70_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_71_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_71_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeBlockAsm8B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_72_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_72_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_73_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_73_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeBlockAsm8B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_74_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_74_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_75_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_75_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x04, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00000400
	JL    assert_check_76_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_76_ok_srcline_258:
	CMPQ R10, $0x00000400
	JL   assert_check_77_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_77_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x38, R9
	CMPQ  R9, $0x00000400
	JL    assert_check_78_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_78_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeBlockAsm8B:
	...
	SUBL  BP, R8
	TESTL R8, R8
	JNZ   assert_check_79_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_79_ok_srcline_841:
	LEAL -1(R8), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeBlockAsm8B:
	...
	SUBL CX, R8
	CMPQ R8, $0x7fffffff
	JL   assert_check_80_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_80_ok_srcline_357:
	LEAQ (DX)(CX*1), R9
	LEAQ (DX)(BP*1), BP
	XORL R12, R12
	CMPL R8, $0x10
...
no_repeat_found_encodeBlockAsm8B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_81_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_81_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_82_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_82_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_83_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_83_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_84_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_84_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_85_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_85_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_86_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_86_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeBlockAsm8B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_87_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_87_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeBlockAsm8B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_88_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_88_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_89_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_89_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeBlockAsm8B
...
matchlen_loopback_match_nolit_encodeBlockAsm8B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeBlockAsm8B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeBlockAsm8B

matchlen_loop_tmp2_match_nolit_encodeBlockAsm8B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeBlockAsm8B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeBlockAsm8B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00000400
	JL    assert_check_90_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_90_ok_srcline_624:
	CMPQ R8, $0x00000400
	JL   assert_check_91_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_91_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeBlockAsm8B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_92_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_92_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeBlockAsm8B:
	CMPQ AX, (SP)
	JL   assert_check_93_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_93_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_94_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_94_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_95_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_95_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeSnappyBlockAsm:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_96_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_96_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_97_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_97_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeSnappyBlockAsm:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_98_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_98_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_99_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_99_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x06, BP
...
assert_check_100_ok_srcline_258:
	CMPQ R10, $0x00010000
	JL   assert_check_101_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_101_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x32, R9
	CMPQ  R9, $0x00010000
	JL    assert_check_102_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_102_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeSnappyBlockAsm:
	...
	SUBL  BP, DI
	TESTL DI, DI
	JNZ   assert_check_103_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_103_ok_srcline_841:
	LEAL -1(DI), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeSnappyBlockAsm:
	...
	SUBL CX, DI
	CMPQ DI, $0x7fffffff
	JL   assert_check_104_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_104_ok_srcline_357:
	LEAQ (DX)(CX*1), R8
	LEAQ (DX)(BP*1), BP
	XORL R11, R11
	CMPL DI, $0x10
...
no_repeat_found_encodeSnappyBlockAsm:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_105_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_105_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_106_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_106_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_107_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_107_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_108_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_108_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_109_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_109_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_110_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_110_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeSnappyBlockAsm:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_111_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_111_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeSnappyBlockAsm:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_112_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_112_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_113_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_113_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeSnappyBlockAsm
...
matchlen_loopback_match_nolit_encodeSnappyBlockAsm:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeSnappyBlockAsm

matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeSnappyBlockAsm:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeSnappyBlockAsm:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00010000
	JL    assert_check_114_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_114_ok_srcline_624:
	CMPQ R8, $0x00010000
	JL   assert_check_115_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_115_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeSnappyBlockAsm:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_116_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_116_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeSnappyBlockAsm:
	CMPQ AX, (SP)
	JL   assert_check_117_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_117_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_118_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_118_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_119_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_119_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeSnappyBlockAsm12B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_120_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_120_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_121_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_121_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeSnappyBlockAsm12B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_122_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_122_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_123_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_123_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x05, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00004000
	JL    assert_check_124_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_124_ok_srcline_258:
	CMPQ R10, $0x00004000
	JL   assert_check_125_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_125_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x34, R9
	CMPQ  R9, $0x00004000
	JL    assert_check_126_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_126_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeSnappyBlockAsm12B:
	...
	SUBL  BP, DI
	TESTL DI, DI
	JNZ   assert_check_127_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_127_ok_srcline_841:
	LEAL -1(DI), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeSnappyBlockAsm12B:
	...
	SUBL CX, DI
	CMPQ DI, $0x7fffffff
	JL   assert_check_128_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_128_ok_srcline_357:
	LEAQ (DX)(CX*1), R8
	LEAQ (DX)(BP*1), BP
	XORL R11, R11
	CMPL DI, $0x10
...
no_repeat_found_encodeSnappyBlockAsm12B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_129_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_129_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_130_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_130_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_131_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_131_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_132_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_132_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_133_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_133_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_134_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_134_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeSnappyBlockAsm12B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_135_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_135_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeSnappyBlockAsm12B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_136_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_136_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_137_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_137_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeSnappyBlockAsm12B
...
matchlen_loopback_match_nolit_encodeSnappyBlockAsm12B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm12B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeSnappyBlockAsm12B

matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm12B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeSnappyBlockAsm12B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeSnappyBlockAsm12B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00004000
	JL    assert_check_138_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_138_ok_srcline_624:
	CMPQ R8, $0x00004000
	JL   assert_check_139_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_139_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeSnappyBlockAsm12B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_140_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_140_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeSnappyBlockAsm12B:
	CMPQ AX, (SP)
	JL   assert_check_141_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_141_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_142_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_142_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_143_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_143_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeSnappyBlockAsm10B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_144_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_144_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_145_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_145_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeSnappyBlockAsm10B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_146_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_146_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_147_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_147_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x05, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00001000
	JL    assert_check_148_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_148_ok_srcline_258:
	CMPQ R10, $0x00001000
	JL   assert_check_149_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_149_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x36, R9
	CMPQ  R9, $0x00001000
	JL    assert_check_150_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_150_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeSnappyBlockAsm10B:
	...
	SUBL  BP, DI
	TESTL DI, DI
	JNZ   assert_check_151_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_151_ok_srcline_841:
	LEAL -1(DI), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeSnappyBlockAsm10B:
	...
	SUBL CX, DI
	CMPQ DI, $0x7fffffff
	JL   assert_check_152_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_152_ok_srcline_357:
	LEAQ (DX)(CX*1), R8
	LEAQ (DX)(BP*1), BP
	XORL R11, R11
	CMPL DI, $0x10
...
no_repeat_found_encodeSnappyBlockAsm10B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_153_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_153_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_154_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_154_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_155_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_155_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_156_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_156_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_157_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_157_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_158_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_158_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeSnappyBlockAsm10B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_159_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_159_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeSnappyBlockAsm10B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_160_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_160_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_161_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_161_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeSnappyBlockAsm10B
...
matchlen_loopback_match_nolit_encodeSnappyBlockAsm10B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm10B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeSnappyBlockAsm10B

matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm10B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeSnappyBlockAsm10B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeSnappyBlockAsm10B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00001000
	JL    assert_check_162_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_162_ok_srcline_624:
	CMPQ R8, $0x00001000
	JL   assert_check_163_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_163_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeSnappyBlockAsm10B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_164_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_164_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeSnappyBlockAsm10B:
	CMPQ AX, (SP)
	JL   assert_check_165_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_165_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_166_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_166_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_167_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_167_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
zero_loop_encodeSnappyBlockAsm8B:
	...
	LEAQ  -8(CX), BP
	CMPQ  BP, src_len+32(FP)
	JL    assert_check_168_ok_srcline_175
	INT   $0x03
	INT   $0x03

assert_check_168_ok_srcline_175:
	MOVL BP, 8(SP)
	SHRQ $0x05, CX
	SUBL CX, DX
	CMPQ src_len+32(FP), DX
	JGE  assert_check_169_ok_srcline_186
	INT  $0x03
	INT  $0x03

assert_check_169_ok_srcline_186:
	LEAQ (AX)(DX*1), DX
	MOVQ DX, (SP)
	MOVL $0x00000001, CX
	MOVL CX, 16(SP)
...
search_loop_encodeSnappyBlockAsm8B:
	MOVQ src_base+24(FP), BP
	CMPQ BP, DX
	JEQ  assert_check_170_ok_srcline_212
	INT  $0x03
	INT  $0x03

assert_check_170_ok_srcline_212:
	MOVQ src_len+32(FP), BP
	CMPQ BP, CX
	JG   assert_check_171_ok_srcline_219
	INT  $0x03
	INT  $0x03

assert_check_171_ok_srcline_219:
	MOVQ  (DX)(CX*1), SI
	MOVL  CX, BP
	SUBL  12(SP), BP
	SHRL  $0x04, BP
	...
	MOVL  24(SP)(R10*4), DI
	CMPQ  R9, $0x00000400
	JL    assert_check_172_ok_srcline_258
	INT   $0x03
	INT   $0x03

assert_check_172_ok_srcline_258:
	CMPQ R10, $0x00000400
	JL   assert_check_173_ok_srcline_262
	INT  $0x03
	INT  $0x03

assert_check_173_ok_srcline_262:
	MOVL  CX, 24(SP)(R9*4)
	LEAL  1(CX), R9
	MOVL  R9, 24(SP)(R10*4)
	MOVQ  SI, R9
	...
	SHRQ  $0x38, R9
	CMPQ  R9, $0x00000400
	JL    assert_check_174_ok_srcline_281
	INT   $0x03
	INT   $0x03

assert_check_174_ok_srcline_281:
	MOVL CX, R8
	SUBL 16(SP), R8
	MOVL 1(DX)(R8*1), R10
	MOVQ SI, R8
...
repeat_extend_back_end_encodeSnappyBlockAsm8B:
	...
	SUBL  BP, DI
	TESTL DI, DI
	JNZ   assert_check_175_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_175_ok_srcline_841:
	LEAL -1(DI), BP
	CMPL BP, $0x3c
...
emit_literal_done_repeat_emit_encodeSnappyBlockAsm8B:
	...
	SUBL CX, DI
	CMPQ DI, $0x7fffffff
	JL   assert_check_176_ok_srcline_357
	INT  $0x03
	INT  $0x03

assert_check_176_ok_srcline_357:
	LEAQ (DX)(CX*1), R8
	LEAQ (DX)(BP*1), BP
	XORL R11, R11
	CMPL DI, $0x10
...
no_repeat_found_encodeSnappyBlockAsm8B:
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_177_ok_srcline_410
	INT  $0x03
	INT  $0x03

assert_check_177_ok_srcline_410:
	CMPL CX, BP
	JG   assert_check_178_ok_srcline_416
	INT  $0x03
	INT  $0x03

assert_check_178_ok_srcline_416:
	MOVQ src_len+32(FP), R8
	CMPL R8, DI
	JG   assert_check_179_ok_srcline_420
	INT  $0x03
	INT  $0x03

assert_check_179_ok_srcline_420:
	CMPL CX, DI
	JG   assert_check_180_ok_srcline_426
	INT  $0x03
	INT  $0x03

assert_check_180_ok_srcline_426:
	CMPL (DX)(BP*1), SI
	...
	MOVQ src_len+32(FP), R8
	CMPL R8, BP
	JG   assert_check_181_ok_srcline_440
	INT  $0x03
	INT  $0x03

assert_check_181_ok_srcline_440:
	LEAL 2(CX), R8
	CMPL R8, BP
	JG   assert_check_182_ok_srcline_446
	INT  $0x03
	INT  $0x03

assert_check_182_ok_srcline_446:
	LEAL 2(CX), R8
	CMPL (DX)(DI*1), SI
...
match_dst_size_check_encodeSnappyBlockAsm8B:
	...
	SUBL  DI, R8
	TESTL R8, R8
	JNZ   assert_check_183_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_183_ok_srcline_841:
	LEAL -1(R8), DI
	CMPL DI, $0x3c
...
match_nolit_loop_encodeSnappyBlockAsm8B:
	...
	ADDL $0x04, BP
	CMPL CX, BP
	JG   assert_check_184_ok_srcline_556
	INT  $0x03
	INT  $0x03

assert_check_184_ok_srcline_556:
	MOVQ src_len+32(FP), SI
	SUBL CX, SI
	CMPQ SI, $0x7fffffff
	JL   assert_check_185_ok_srcline_565
	INT  $0x03
	INT  $0x03

assert_check_185_ok_srcline_565:
	LEAQ (DX)(CX*1), DI
	LEAQ (DX)(BP*1), BP
	XORL R10, R10
	CMPL SI, $0x10
	JL   matchlen_four_match_nolit_encodeSnappyBlockAsm8B
...
matchlen_loopback_match_nolit_encodeSnappyBlockAsm8B:
	...
	XORQ  8(BP), R9
	TESTQ R8, R8
	JZ    matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm8B
	BSFQ  R8, R8
	SARQ  $0x03, R8
	LEAL  (R10)(R8*1), R10
	JMP   match_nolit_end_encodeSnappyBlockAsm8B

matchlen_loop_tmp2_match_nolit_encodeSnappyBlockAsm8B:
	TESTQ R9, R9
...
matchlen_four_match_nolit_encodeSnappyBlockAsm8B:
	SUBL $0x04, SI
...
match_nolit_dst_ok_encodeSnappyBlockAsm8B:
	...
	LEAL  -2(CX), R9
	CMPQ  DI, $0x00000400
	JL    assert_check_186_ok_srcline_624
	INT   $0x03
	INT   $0x03

assert_check_186_ok_srcline_624:
	CMPQ R8, $0x00000400
	JL   assert_check_187_ok_srcline_628
	INT  $0x03
	INT  $0x03

assert_check_187_ok_srcline_628:
	MOVL 24(SP)(R8*4), BP
	MOVL R9, 24(SP)(DI*4)
	MOVL CX, 24(SP)(R8*4)
	CMPL (DX)(BP*1), SI
...
emit_remainder_ok_encodeSnappyBlockAsm8B:
	...
	SUBL  BX, BP
	TESTL BP, BP
	JNZ   assert_check_188_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_188_ok_srcline_841:
	LEAL -1(BP), DX
	CMPL DX, $0x3c
...
emit_literal_done_emit_remainder_encodeSnappyBlockAsm8B:
	CMPQ AX, (SP)
	JL   assert_check_189_ok_srcline_674
	INT  $0x03
	INT  $0x03

assert_check_189_ok_srcline_674:
	MOVQ dst_base+0(FP), CX
	SUBQ CX, AX
	CMPQ src_len+32(FP), AX
	JGE  assert_check_190_ok_srcline_687
	INT  $0x03
	INT  $0x03

assert_check_190_ok_srcline_687:
	CMPQ dst_len+8(FP), AX
	JGE  assert_check_191_ok_srcline_693
	INT  $0x03
	INT  $0x03

assert_check_191_ok_srcline_693:
	MOVQ AX, ret+48(FP)
	RET
...
TEXT ·emitLiteral(SB), NOSPLIT, $0-56
	...
	TESTL DX, DX
	JNZ   assert_check_192_ok_srcline_841
	INT   $0x03
	INT   $0x03

assert_check_192_ok_srcline_841:
	MOVL DX, BX
	LEAL -1(DX), BP
	CMPL BP, $0x3c
...
matchlen_loopback_standalone:
	...
	XORQ  8(CX), BP
	TESTQ BX, BX
	JZ    matchlen_loop_tmp2_standalone
	BSFQ  BX, BX
	SARQ  $0x03, BX
	LEAL  (SI)(BX*1), SI
	JMP   gen_match_len_end

matchlen_loop_tmp2_standalone:
	TESTQ BP, BP
