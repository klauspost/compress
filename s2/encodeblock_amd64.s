...
TEXT ·encodeBlockAsm(SB), $65632-56
	MOVQ $0x00000200, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
...
TEXT ·encodeBlockAsm14B(SB), $16480-56
	MOVQ $0x00000080, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
...
TEXT ·encodeBlockAsm12B(SB), $4192-56
	MOVQ $0x00000020, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
...
TEXT ·encodeBlockAsmAvx(SB), $65632-56
	MOVQ $0x00000200, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
...
TEXT ·encodeBlockAsm14BAvx(SB), $16480-56
	MOVQ $0x00000080, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
...
TEXT ·encodeBlockAsm12BAvx(SB), $4192-56
	MOVQ $0x00000020, AX
	LEAQ 96(SP), CX
	PXOR X0, X0
