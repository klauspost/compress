// Code generated by command: go run gen.go -x64v3 -out ../encodeblock_v3_amd64.s -stubs ../encodeblock_v3_amd64.go -pkg=s2. DO NOT EDIT.

//go:build !appengine && !noasm && gc && GOAMD64_v3 && !noasm
// +build !appengine,!noasm,gc,GOAMD64_v3,!noasm
