...
func TestEmitCopy(t *testing.T) {
	testCases := []struct {
		...
		{8, 68, "\xfe\x08\x00\x01\x00"},
		{8, 69, "\xfe\x08\x00\x05\x00"},
		{8, 80, "\xfe\x08\x00\x15\x00\x08"},
		{8, 800, "\xfe\x08\x00\x19\x00\xdc\x01"},
		...
		{256, 68, "\xfe\x00\x01\x01\x00"},
		{256, 69, "\xfe\x00\x01\x05\x00"},
		{256, 80, "\xfe\x00\x01\x15\x00\x08"},
		{256, 800, "\xfe\x00\x01\x19\x00\xdc\x01"},
		...
		{2048, 68, "\xfe\x00\x08\x01\x00"},
		{2048, 69, "\xfe\x00\x08\x05\x00"},
		{2048, 80, "\xfe\x00\x08\x15\x00\x08"},
		{2048, 800, "\xfe\x00\x08\x19\x00\xdc\x01"},
