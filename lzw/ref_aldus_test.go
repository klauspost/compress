...
// This file is a copy of golang.org/x/image/tiff/lzw/reader.go, taken at
// v0.41.0 and used only as an independent reference for the Aldus variant that
// Reader.SetAldusCompatible selects. It is deliberately left as close to
// upstream as possible: only the package clause and the doc comment differ, so
// that a future upstream change can be diffed against it.
//
// It lives in an external test package so that its identifiers cannot collide
// with the ones being tested.

// Package lzw implements the Lempel-Ziv-Welch compressed data format,
// described in T. A. Welch, “A Technique for High-Performance Data
// Compression”, Computer, 17(6) (June 1984), pp 8-19.
//
// Upstream doc: it implements LZW as used by the TIFF file format, including
